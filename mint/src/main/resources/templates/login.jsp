	...
	<div class="container-fluid">
		<div class="row col-lg-4 col-lg-offset-4"
			...
			<form th:action="@{/login}" method="POST" class="form-signin"
				...
				<br /> <input type="text" id="email" name="email" th:field="*{userName}"
					th:placeholder="Email" class="form-control" /> <br /> <input
					type="password" th:placeholder="Password" id="password" th:field="*{userPwd}"
				...
				<button class="btn btn-lg btn-primary" name="Submit" value="Login"
					type="Submit" th:text="Login" style="margin-right: 10px;"></button>
